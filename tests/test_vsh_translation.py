...
for r, n, m in miepy.mode_indices(lmax):
    for s, v, u in miepy.mode_indices(lmax):
        ### original A and B
        A, B = miepy.vsh.vsh_translation(m, n, u, v, r_ji, theta_ji, phi_ji, k, miepy.vsh.vsh_mode.outgoing)

        ### same mode, but reverse position
        A_calc, B_calc = miepy.vsh.vsh_translation(
            m, n, u, v, r_ji, np.pi - theta_ji, np.pi + phi_ji, k, miepy.vsh.vsh_mode.outgoing
        )
        ...
        A_calc, B_calc = miepy.vsh.vsh_translation(-u, v, -m, n, r_ji, theta_ji, phi_ji, k, miepy.vsh.vsh_mode.outgoing)
        ...
        A_calc, B_calc = miepy.vsh.vsh_translation(
            -u, v, -m, n, r_ji, np.pi - theta_ji, np.pi + phi_ji, k, miepy.vsh.vsh_mode.outgoing
        )
