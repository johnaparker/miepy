...
def scattered_E(an, bn, k):
    ...
    def E_func(r, theta, phi):
        ...
        for L in range(1, lmax + 1):
            ...
            E += En * (1j * an[L - 1] * VSH.N_e1n(k)(r, theta, phi) - bn[L - 1] * VSH.M_o1n(k)(r, theta, phi))
        return -E
...
def interior_E(cn, dn, k):
    ...
    def E_func(r, theta, phi):
        ...
        for L in range(1, lmax + 1):
            ...
            E += En * (cn[L - 1] * VSH.M_o1n(k)(r, theta, phi) - 1j * dn[L - 1] * VSH.N_e1n(k)(r, theta, phi))
        return -E
    ...
    def H_func(r, theta, phi):
        ...
        for L in range(1, lmax + 1):
            ...
            H += (
                ...
                * En
                / mu_b
                * (1j * bn[L - 1] * VSH.N_o1n(k)(r, theta, phi) + an[L - 1] * VSH.M_e1n(k)(r, theta, phi))
            )
        return -H
...
def interior_H(cn, dn, k, n, mu):
    ...
    def H_func(r, theta, phi):
        ...
        for L in range(1, lmax + 1):
            ...
            VSH = vector_spherical_harmonics(L, 1)
            H += -n * En / mu * (dn[L - 1] * VSH.M_e1n(k)(r, theta, phi) + 1j * cn[L - 1] * VSH.N_o1n(k)(r, theta, phi))
        return -H
